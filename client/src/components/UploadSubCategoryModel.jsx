...
const UploadSubCategoryModel = ({ close, fetchData }) => {
  ...
  const handleSubmitSubCategory = async (e) => {
    ...
    try {
      const response = await Axios({
        ...
        data: {
          ...subCategoryData,
          category: subCategoryData.category[0]?._id,
        },
      });
  ...
  return (
    <section className="fixed top-0 bottom-0 right-0 left-0 z-50 bg-neutral-800/60 flex items-center justify-center p-4">
